      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {/* Instagram Link */}
            <a href="https://instagram.com/charcuteriedeparis" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gold hover:text-soft-gold transition-colors">
