      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {/* Instagram Link */}
            <a href="https://www.instagram.com/charcuterie_de_paris" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gold hover:text-soft-gold transition-colors">
              ...
              <span className="text-sm">@charcuterie_de_paris</span>
            </a>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-cream/80">
              ...
              <p>Monday – Saturday</p>
              <p>48-hour advance notice preferred</p>
            </div>
          </div>
        </div>

        <div className="border-t border-cream/20 mt-8 pt-8 text-center text-sm text-cream/60">
          <p>&copy; {new Date().getFullYear()} Charcuterie de Paris. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
